    ...
    <div class="my-auto upload-container">
        <form action="includes/gallery-helper.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <img src="images/rodrick-thumb.jpg" onclick="triggered();" id="gallery-display">
            ...
            <div class="form-group">
                <button type="submit" name="gallery-submit" class="btn btn-dark btn-lg btn-block" style="font-family: 'Lucida Console', Courier, monospace;">Upload</button>
            </div>
        </form>
    </div>
</div>
