        ...
        <div class="my-auto">
            <form id="review-form" action="includes/review-helper.php" method="post">
                ...
                <div class="form-group" style="margin-top: 15px;">
                    ...
                    <input type="text" name="review-title" id="review-title" style="font-family: 'CoopForged'; width: 100%; margin-bottom: 10px;">
                    <textarea class="form-control" id="review-text" name="review" cols="50" rows="3" placeholder="Enter a comment..." style="font-family: 'CoopForged';"></textarea>
